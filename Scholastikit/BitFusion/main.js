...
var App = {
  init: function () {
    this.bindEvents();
    UI.human.io.textContent = "Made By Priyanshu";
...
document
  ...
  .addEventListener("click", () =>
    convertBit(binaryOutput.value, "bOutput", "binary", "decimal")
  );
document
  .querySelector("#bToH")
  .addEventListener("click", () =>
    convertBit(binaryOutput.value, "bOutput", "binary", "hex")
  );
document
  .querySelector("#dToB")
  .addEventListener("click", () =>
    convertBit(decimalOutput.value, "dOutput", "decimal", "binary")
  );
document
  .querySelector("#dToH")
  .addEventListener("click", () =>
    convertBit(decimalOutput.value, "dOutput", "decimal", "hex")
  );
document
  .querySelector("#hToB")
  .addEventListener("click", () =>
    convertBit(hexOutput.value, "hOutput", "hex", "binary")
  );
document
  .querySelector("#hToD")
  .addEventListener("click", () =>
    convertBit(hexOutput.value, "hOutput", "hex", "decimal")
  );
  ...
  switch (from) {
    case "binary":
      document.getElementById(output).textContent =
        to === "decimal" ? binToDec(src) : binToHex(src);
      break;
    case "decimal":
      document.getElementById(output).textContent =
        to === "binary" ? decToBin(src) : decToHex(src);
      break;
    case "hex":
      document.getElementById(output).textContent =
        to === "binary" ? hexToBin(src) : hexToDec(src);
      break;
  }
}
